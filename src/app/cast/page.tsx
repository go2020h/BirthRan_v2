  ...
  const staffData = [
    {
      ...
      description: '誕生日をお祝いしたい人が居る。誕生日をお祝いしてくれる人が居る。とても幸せなことです。私は…、誕生日に産んでくれてありがとう、育ててくれてありがとうという想いを込めて両親にプレゼントを渡しています。その時に出会える最高の笑顔が大好きなんです。この番組を通じ誕生日にお祝いすることがとても素敵な時間であることを見直して欲しいと願っています。幸せを呼ぶ魔法の言葉「おめでとう」「ありがとう」、そして「おかえりなさい」「またねー」で愛情ホルモン・オキシトシン溢れる番組を目指していきます（笑）'
    },
    {
      id: 'staff2',
      name: '梅本満',
    ...
    },
    {
      ...
      description: 'ラジオ一筋　？十年！　最近は、のむDと呼ばれてます。これまでいろいろな番組に携わってきましたが、誕生日おめでとうを2時間半やる番組なんて初めてです。誰もが持ってる誕生日、祝われても、祝っても幸せな気持ちになれる誕生日。皆さんのやさしい気持ちを伝えられる番組になるよう尽力致します！'
    },
    {
      id: 'staff4',
      name: 'Konomi',
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto bg-[#1a2547] rounded-xl shadow-lg overflow-hidden p-8">
              <div className="text-white leading-relaxed space-y-6">
                <p>
                  「<span className="text-[#d4af37] font-bold">デイリー・バースデー・ランキング</span>」は、視聴者の皆さまに「誕生日」という特別な日を通じて、新しい発見と感動をお届けする番組です。私たち制作チームは、この番組を通じて、視聴者の皆さまに「誕生日」という特別な日の魅力を再発見していただきたいと考えています。
                </p>
                <p>
                ...
                <p>
                  これからも、視聴者の皆さまに「驚き」と「感動」をお届けできるよう、スタッフ一同、全力で取り組んでまいります。どうぞ、これからも「<span className="text-[#d4af37] font-bold">デイリー・バースデー・ランキング</span>」をよろしくお願いいたします。
                </p>
