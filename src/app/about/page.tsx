              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-[#d4af37] hover:shadow-md transition-all duration-300">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold text-[#1a3a6c]">18時40分頃／（今週月曜日の）『バスランベスト３の発表！』</h3>
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-[#FF6B6B] hover:shadow-md transition-all duration-300">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold text-[#1a3a6c]">19時2分頃／『おめありレコメンド』(13分)</h3>
                  </div>
                  <p className="text-gray-700 ml-10">お客様やSTAFFから「おめでとう」「ありがとう」という言葉が集まっている愛ある商品やサービス、会社をご紹介するコーナーです。<br />
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-[#d4af37] hover:shadow-md transition-all duration-300">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold text-[#1a3a6c]">19時18分頃／（今週火曜日の）『バスランベスト３の発表！』</h3>
                  </div>
               ...
               <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-[#d4af37] hover:shadow-md transition-all duration-300">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold text-[#1a3a6c]">19時31分頃／（今週水曜日の）『バスランベスト３の発表！』</h3>
                  </div>
                 ...
                 <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-[#d4af37] hover:shadow-md transition-all duration-300">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold text-[#1a3a6c]">19時44分頃／（今週木曜日の）『バスランベスト３の発表！』</h3>
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border-l-4 border-[#FF6B6B] hover:shadow-md transition-all duration-300">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold text-[#1a3a6c]">20時1分頃／『もうすぐ誕生日！ようこそバスランへ！』(28分)</h3>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#FF6B6B] hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed ml-12">
                  『バスラン』がセレクトした「おめでとう」「ありがとう」の言葉が集まっている愛ある商品やサービスをご紹介する『おめありレコメンド』のコーナーより！<br />
                  『もうすぐ誕生日！ようこそバスランへ！』にご出演頂くゲストの方へ！<br />
                  一足早い！誕生日プレゼントをご提供いただいております。お楽しみに～♡
                </p>
              </div>
