...
export const guestArchive: GuestData[] = [
  ...
  },
  {
    ...
    bio: "【趣味】愛犬のトリミング　乗馬　映画・ドラマ・アニメ観賞　動物との触れ合い【スポーツ】バレーボール【好きな食べ物】トマト・ローストビーフ・生ハム・タン塩・ラーメン【特技】一輪車（永遠に乗れます）　老若男女誰とでも仲良くできる【楽器】アコースティックギター【資格】乗馬技能認定5級　原付免許\n【略歴】平成26年2月（小３）、８月（小４）　2回出演　テレビ朝日「関ジャニの仕分け∞」平成26年12月（小４）　日本テレビ「歌唱王」平成30年4月（中２）　関西テレビ「MUJACK」平成27年8月（小５）～平成30年2月（中１）計11回出演　テレビ東京「THEカラオケバトル」NHKのど自慢グランドチャンピオン大会",
