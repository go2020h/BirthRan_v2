...
export const guestArchive: GuestData[] = [
  ...
  },
  {
    ...
    name: "花谷麻妃",
    image: "/guest/guest44.jpg",
    bio: "兵庫県神戸市出身で、趣味はクマグッズ集め・テディベア作り・ミシン・カメラ・ゲーム・犯罪心理学(認定心理士)・ギター・バムとケロを読むこと・絵を書くこと・音楽を聞くこと(昭和や平成問わず)。特技は剣道(２段)・餃子包み・耳を動かすことです。皆さんから、花ちゃんや麻妃ちゃんと呼ばれることが多いです。\n♪　これまでにもらった誕生日プレゼントで印象に残ってるものは？\n二十歳の誕生日に母からもらった指輪とネックレスです。",
    appearanceDate: "2025年2月26日",
    birthDate: "3月16日",
    officialSite: "https://remax-web.jp/talent/hanatani-m/",
    twitter: "https://x.com/h_maki_official?s=21&t=yFiC3o3Bku78q-p_1LbtKQ",
    twitter2: "",
    instagram: ""
  }, {
    name: "舞乃空",
    image: "/guest/guest45.jpg",
    bio: "【趣味】愛犬のトリミング　乗馬　映画・ドラマ・アニメ観賞　動物との触れ合い\n【スポーツ】バレーボール\n【好きな食べ物】トマト・ローストビーフ・生ハム・タン塩・ラーメン\n【特技】一輪車（永遠に乗れます）　老若男女誰とでも仲良くできる\n【楽器】アコースティックギター\n【資格】乗馬技能認定5級　原付免許\n【略歴】平成26年2月（小３）、８月（小４）　2回出演　テレビ朝日「関ジャニの仕分け∞」\n平成26年12月（小４）　日本テレビ「歌唱王」\n平成30年4月（中２）　関西テレビ「MUJACK」\n平成27年8月（小５）～平成30年2月（中１）計11回出演　テレビ東京「THEカラオケバトル」NHKのど自慢グランドチャンピオン大会",
    appearanceDate: "2025年3月5日",
    birthDate: "3月22日",
    officialSite: "https://www.crownrecord.co.jp/s/c01/artist/manoa/profile?ima=1257&ct=ryuko",
    ...
    name: "KORI",
    image: "/guest/guest47.jpg",
    bio: "テクノロジーの進化とエンターテインメントの融合が加速する現代において、 ガールズグループ・シーンの華やかさやバズを生む音楽的な要素を取り入れつつ、 古くから受け継がれてきた日本文化のエッセンスを現代的に再構築する『BENNY』でボーカルを務める。「ジャパンコア」というコンセプトを掲げ、日本のポップカルチャーが世界から注目を集める今、 その可能性をさらに拡張し、未来に向けて進化させることを目指す。次世代へ受け継がれる“新しいクールジャパン”を再定義し、国内外のステージで日本発の表現を発信していく。大阪府出身、韓国語が得意で趣味は格闘技を見る事です！\n♪これまでにもらった誕生日プレゼントで印象に残ってるものは？\n20歳の頃に母から買ってもらったコートです！成人祝いで一生もののコートを買ってもらいました。",
    appearanceDate: "2025年3月19日",
    birthDate: "3月28日",
    officialSite: "https://benny-official.com/",
  ...
  , {
    name: "おだともあき",
    image: "/guest/guest61.jpg",
    bio: "いしかわ観光特使、白山市観光特使。ボーカルグループ「aoiro」の活動を経て、2021年6月より再始動。ギターとピアノで作詞・作曲・演奏を行う。代表曲「おつかれさまのうた」はYouTube300万回再生を突破。ドラマや映画での書き下ろしの主題歌、挿入歌を経験。舞台への楽曲提供や出演も果たし俳優としても活動をスタート。島村楽器ブランドムービーに出演。2025年12月公開の映画「初恋芸人」にて挿入歌に抜擢更には、2026年6月公開の映画「おかえりの湯」で主題歌に抜擢される地元、石川県ではMROラジオにて毎週木曜19:00～放送のラジオ冠番組を持つ。2024年の能登半島地震・豪雨を機に同年10月より石川県へ拠点を移し、能登復興支援コンサートを定期的に開催。また障がい者支援事業者、訪問看護事業者とともに、障がい者の自立をサポートする楽曲制作にも力をいれ、障がいがあっても夢を諦めないサポートを行っている。中学生ギャップへの取り組みとして、同じ中学校へ進学する金沢の小学校3校に通い子供達と一つの卒業ソングを制作するなど、不登校支援や自殺防止プロジェクトにも力を入れている。ノスタルジックな歌声と楽曲で、幅広い世代に支持を受ける。「まあるく柔らかく心を解す歌うたい 」として現在、石川県を拠点に全国各地で歌を届けている。",
    appearanceDate: "2026年7月23日",
    birthDate: "8月14日",
    officialSite: "https://odatomoaki.bitfan.id/",
    ...
    name: "斎藤瑠希",
    image: "/guest/guest64.jpg",
    bio: "渡辺ミュージカル芸術学院1期卒業生\n数々の舞台に出演する、歌手・ミュージカル俳優・声優さんです。\n【最新情報】\n★舞台『黎明ロマンティック』7月17日～20日 @あうるすぽっと\n★2ndソロライブ「TILL FULL MooN」開催決定  9月18日、19日@月見ル君想フ（東京）\nこれまでにも…\n★ディズニー 『 ミラベルと魔法だらけの家 』主人公・ミラベル役の日本版声優に大抜擢！\n★2025年に日本初演を行ったミュージカル『SIX』で6人の王妃の一人、キャサリン・パー役をフルオーディションで射止める\n★2025年9月NHKホールで行われた「MISIA SOUL JAZZ FUNK CITY」にフロントアクトとして出演\n★2026年1月東京・青山月見ル君想フ MOONROMANTICで初のソロライブ『TILL FULL MooN』開催。という華麗な経歴をお持ちです。\n【趣味・特技】\nジャンル問わず何でも対応して歌える／ 既存の曲を耳コピして音源を作成、その曲をカバーすること／歩きながら音楽の雰囲気になりきること／電車に乗っているときに人をスケッチすること／ 80’ｓの洋楽を探すこと／刺繍／イラスト",
    appearanceDate: "2026年8月13日",
    birthDate: "9月26日",
    officialSite: "",
    ...
    name: "ミナト・C・エンペラー （メンバーカラー:ブルー）・ターゴ・C・マーキス（メンバーカラー:オレンジ）",
