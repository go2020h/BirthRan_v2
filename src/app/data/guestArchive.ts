...
export const guestArchive: GuestData[] = [
  ...
  },
  {
    ...
    bio: "「俳優」劇団四季でキャリアをスタート、退団後は舞台、映像で幅広く活動 第31回読売演劇大賞優秀男優賞、第49回菊田一夫演劇賞受賞 10月7日から放送開始のフジテレビ系火曜ドラマ「新東京水上警察」に出演。 11月7日(金)全国公開する長編アニメーション映画「トリツカレ男」では主人公の相棒のハツカネズミ・シエロの声を担当します。 また、来年3月から再演するミュージカル「ジキル＆ハイド」でも主演を務めます。 2026年1月にウエンツ瑛士、木南晴夏とのユニット「カキンツハルカ」でのライブツアーが開催決定！ ♪　これまでにもらった誕生日プレゼントで印象に残っているものは？ →家族から貰った水泳用ゴーグルと稽古用のスニーカー 「俳優・タレント」4歳でモデルデビュー。2005年～2016年2月まで小池徹平とのデュオ「WaT」として活動。『第56回NHK紅白歌合戦』にメジャーデビューから史上最短で初出場を果たす。2024年から「カキンツハルカ」としての活動もはじめる。 ♪ これまでにもらった誕⽣⽇プレゼントで印象に残ってるものは？ →保温機能がついていない高級炊飯器",
